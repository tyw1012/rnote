 ...
 mysqli_set_charset($con,"utf8");
    ...
    if($level == 'emp'){
        if($selectedSegment=='임대'){
            $sql_query = "select count(*) as count from g5_write_$memberID where board_list = '$selectedOfferingType' and wr_sale_type = 1 and wr_sold_out != 1 ";        
        }
            ...
            $sql_query = "select count(*) as count from g5_write_$memberID where board_list = '$selectedOfferingType' and wr_sold_out = 1 ";
        }
        ...
        if($selectedSegment=='임대'){
            ...
            $sql_query = "select count(*) as count from g5_write_$memberID where board_list = '$selectedOfferingType' and (wr_office_permission='' or wr_office_permission = 2) AND wr_writer = '$memberName' AND wr_sold_out = 1 ";
        }
    }
    ...
    if($level == 'emp'){
        if($selectedSegment=='임대'){
            $sql_query2 = "select * from g5_write_$memberID where board_list = '$selectedOfferingType' and wr_sale_type = 1 and wr_sold_out != 1 ";        
        }
        else if($selectedSegment=='매매'){
