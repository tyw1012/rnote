...

{
    ...
    if ($str)
        ...
        return "<nav class=\"pg_wrap\"><div class=\"pg\">{$str}</div></nav>";
...
function get_group_member($mb_id, $gr_id)

{
    ...
    return sql_fetch(" select * from {$g5['group_member_table']} where mb_id = '$mb_id' and gr_id = '$gr_id' ");
