...
export default class CheckBoxListItem_opt extends Component{
...
_findOptionIndex(optionItem){
    for (var i = 0; i < this.props.options.length; i++){
      if(optionItem.name==this.props.options[i].name){
...
render(){
    ...
    return(
        ...
        this.props.checkboxHandler(item, optionIndex, this.props.selectedItem, 'options');
     
        // let clone = this.props.options.slice(0);
