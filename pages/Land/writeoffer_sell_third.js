...
static updateFigures(){
  ...
  self.setState(self.props.navigation.state.params, function(){
    ...
    self.setState({
          ...
          wr_p_sale_price: self.state.wr_sale_price/self.state.wr_area_p_all
                ...
                <View>
                    ...
                    <View style={{flexDirection: 'row', marginBottom:20,}}>     
                        <View style = {[styles.row,{marginTop:0, marginRight:20,}]}>    
                            ...
                            onChangeText= {wr_sale_price => this.setState({wr_sale_price: wr_sale_price, wr_p_sale_price: Math.round(wr_sale_price/this.state.wr_area_p_all)})}
                  ...
                  <View style={{flexDirection: 'row',}}>    
                        ...
                        <View style = {[styles.row,{marginRight:20}]}>    
                                ...
                                onFocus={(event: Event) => {                                
                                this.scroll.props.scrollToPosition(0, 75)
                                }}
                                />                      
