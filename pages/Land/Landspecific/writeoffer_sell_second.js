...
export default class writeoffer_sell_second extends Component {
  ...
  componentDidMount(){
    ...
    if(this.state.wr_address_sale_added1!=undefined){
      this.setState({addedInput_1_visible:true,})
    }
    if(this.state.wr_address_sale_added2!=undefined){
      this.setState({addedInput_2_visible:true,})
    }
    if(this.state.wr_address_sale_added3!=undefined){
      this.setState({addedInput_3_visible:true,})
    }
    if(this.state.wr_address_sale_added4!=undefined){
      this.setState({addedInput_4_visible:true,})
    }
...
{/* ///////////////////////////////////////////////////다섯번째블락 끝 /////////////////////////////////*/}
               ...
               <TouchableOpacity style={{width:'100%', justifyContent:'center', alignItems:'center', borderWidth:1, borderColor:'#3b4db7', padding:10}}
