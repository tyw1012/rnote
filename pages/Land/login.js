				...
				.then((resJson) =>{
					...
					if (resJson.id == myID){
						if(resJson.level == 'gr_admin'){
							...
							// console.log('그룹장입니다', resJson.level)
							this.props.navigation.navigate('MainNavigator',
							{memberID: myID, memberName: resJson.name, email:resJson.email,contact:resJson.contact, level:'office', boss:resJson.boss, minWrite: resJson.min_write,  });
						}
						else{
							// console.log('그룹장 아닙니다', resJson.level)
							this.props.navigation.navigate('MainNavigator',
							{memberID: myID, memberName: resJson.name, email:resJson.email,contact:resJson.contact, level:'emp', boss:resJson.boss, minWrite: resJson.min_write, });
						}
					}
				})
			}
